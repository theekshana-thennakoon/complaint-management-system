                                ...
                                <tbody>
                                    <?php $i = 1; foreach($data['reports'] as $complaint): ?>
                                        <tr style="transition: all 0.2s ease;">
                                            ...
                                            <td><span class="badge bg-info bg-opacity-10 text-info border border-info rounded-pill px-3 py-1"><i class="fas fa-tag me-1"></i><?php echo htmlspecialchars($complaint->category_name); ?></span></td>
