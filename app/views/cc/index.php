    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4 mt-2">
                <h2 class="mb-0">Chief Clerk Dashboard</h2>
            ...
            <ul class="nav nav-tabs mb-4" id="ccDashboardTabs" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link fw-bold text-success" id="submitted-tab" data-bs-toggle="tab" data-bs-target="#submitted" type="button" role="tab"><i class="fas fa-check-double me-1"></i> Submitted to AO</button>
                </li>
                <li class="nav-item" role="presentation">
            ...
            <div class="tab-content" id="ccDashboardTabsContent">
                <!-- Pending Tab -->
                <div class="tab-pane fade show active" id="pending" role="tabpanel" aria-labelledby="pending-tab">
                    <div class="card shadow border-0 mb-4 rounded-4">
                        <div class="card-header bg-gradient bg-primary text-white py-3 d-flex justify-content-between align-items-center rounded-top-4">
                            <h5 class="mb-0 fw-bold">Pending Complaints (Chief Clerk)</h5>
                        </div>
                        <div class="card-body">
                                        ...
                                        <tbody>
                                            <?php foreach($data['complaints'] as $complaint): ?>
                                                <tr style="transition: all 0.2s ease;">
                                                    ...
                                                    <td>
                                                        <?php if ($complaint->status == 'Rejected by AO'): ?>
                                                    ...
                                                    <td>
                                                        <?php if ($complaint->status == 'Rejected by AO'): ?>
                                                            <a href="<?php echo URLROOT; ?>/cc/edit/<?php echo $complaint->id; ?>" class="btn btn-sm btn-danger rounded-pill px-3 shadow-sm">
                                                                <i class="fas fa-exclamation-circle me-1"></i> Fix Rejection
                                                            </a>
                                                        <?php else: ?>
                                                            <a href="<?php echo URLROOT; ?>/cc/show/<?php echo $complaint->id; ?>" class="btn btn-sm btn-primary rounded-pill px-3 shadow-sm">
                ...
                <div class="tab-pane fade" id="submitted" role="tabpanel" aria-labelledby="submitted-tab">
                    <div class="card shadow border-0 mb-4 rounded-4">
                        <div class="card-header bg-gradient bg-success text-white py-3 d-flex justify-content-between align-items-center rounded-top-4">
                            <h5 class="mb-0 fw-bold">Submitted to AO</h5>
                        </div>
                        <div class="card-body">
                            <?php if (empty($data['submitted_to_ao'])): ?>
                                <div class="text-center py-5 text-muted">
                                    <i class="fas fa-folder-open fa-4x mb-3 text-secondary opacity-50"></i>
                                    <h4>No Reports</h4>
                                    <p>You haven't submitted any complaints to the AO yet.</p>
                                </div>
                            <?php else: ?>
                                <div class="table-responsive p-2">
                                    <table class="table table-hover align-middle border-bottom">
                                        ...
                                        <tbody>
                                            <?php foreach($data['submitted_to_ao'] as $complaint): ?>
                                                <tr style="transition: all 0.2s ease;">
                                                    ...
                                                    <td>
                                                        <a href="<?php echo URLROOT; ?>/cc/show/<?php echo $complaint->id; ?>" class="btn btn-sm btn-outline-success rounded-pill px-3 shadow-sm">
                                        ...
                                        <tbody>
                                            <?php foreach($data['rejected_reports'] as $complaint): ?>
                                                <tr style="transition: all 0.2s ease;">
                                                    ...
                                                    <td>
                                                        <a href="<?php echo URLROOT; ?>/cc/show/<?php echo $complaint->id; ?>" class="btn btn-sm btn-outline-danger rounded-pill px-3 shadow-sm">
                                                            <i class="fas fa-eye me-1"></i> View
                                                        </a>
                                                    </td>
                                                </tr>
