...
<div class="container-fluid mt-4 px-4">
    <div class="row">
        <div class="col-md-8 mx-auto">
            <a href="<?php echo URLROOT; ?>/cc" class="btn btn-secondary mb-4">
                <i class="fas fa-arrow-left"></i> Back to CC Dashboard
            </a>
            
            <?php if($data['complaint']->status == 'Rejected by AO' && $data['reject_log']): ?>
            <div class="alert alert-danger shadow-sm border-danger border-start border-5 mb-4 rounded">
                <h5 class="alert-heading text-danger fw-bold"><i class="fas fa-exclamation-triangle"></i> Rejected by Administrative Officer</h5>
            ...
            <div class="card shadow border-0 rounded-4">
                <div class="card-header bg-gradient bg-primary text-white py-3 rounded-top-4">
                    <h4 class="mb-0"><i class="fas fa-edit"></i> Re-Correct & Resubmit Complaint</h4>
                </div>
                
                <div class="card-body p-4">
                    <form action="<?php echo URLROOT; ?>/cc/edit/<?php echo $data['id']; ?>" method="POST">
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end mt-4">
                            <button type="submit" class="btn btn-primary btn-lg rounded-pill px-5 shadow-sm">
                                <i class="fas fa-paper-plane me-2"></i> Resubmit to AO
                            </button>
                        </div>
                    </form>
                </div>
