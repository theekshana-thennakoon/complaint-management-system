        ...
        <div class="col-md-8 mx-auto">
            ...
            <div class="card shadow-sm border-0 mb-4">
                ...
                <div class="card-body">
                    ...
                    <h5 class="mb-3"><i class="fas fa-gavel"></i> Chief Clerk Decision</h5>
                    <?php if ($data['complaint']->current_role_id == 5): ?>
                        <form action="<?php echo URLROOT; ?>/cc/approve/<?php echo $data['complaint']->id; ?>" method="post" id="decisionForm">
                            <div class="mb-3">
                            ...
                            <div class="d-flex gap-2 justify-content-end">
                                ...
                                <button type="button" class="btn btn-success" onclick="submitDecision('approve')">
                                    <i class="fas fa-check-circle"></i> Approve & Forward to AO
                                </button>
                            </div>
                        </form>
                    <?php else: ?>
...
function submitDecision(action) {
    ...
    if (action === 'reject') {
        ...
        form.action = '<?php echo URLROOT; ?>/cc/reject/<?php echo $data['complaint']->id; ?>';
        Swal.fire({
            title: 'Are you sure?',
            text: 'Are you sure you want to REJECT this complaint?',
            icon: 'warning',
        ...
        form.action = '<?php echo URLROOT; ?>/cc/approve/<?php echo $data['complaint']->id; ?>';
        Swal.fire({
            title: 'Are you sure?',
            text: 'Are you sure you want to APPROVE and forward this complaint?',
            icon: 'question',
            showCancelButton: true,
